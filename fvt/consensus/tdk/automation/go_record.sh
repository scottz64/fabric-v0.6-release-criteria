...
# These are specifically for the go tdk code scripts. They are not used by
...
echo -e "REPOSITORY_SOURCE used by GO TDK to retrieve the fabric COMMIT image: $REPOSITORY_SOURCE"
...
# This is used by the GO TDK to determine which repository to retrieve the image from.
