...
func main() {
	...
	chco2.CurrentTestName = "CAT_407_S0S1S2_D_I_R0R1_IQ.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	//	chco2.InvokeOnThisPeer(totalInvokes int, peerNum int)
	...
	chco2.DeployNew(10000, 10000) 		// to VP3
	...
	chco2.InvokeOnThisPeer( 77, 0 )
	chco2.InvokeOnThisPeer( 2, 1 )
	chco2.InvokeOnThisPeer( 8, 3 )
	fmt.Println("Sleep extra 180 secs") ; time.Sleep(chco2.SleepTimeSeconds(180))
	chco2.QueryAllPeers( "STEP 6, after stopped 3 peers (including vp0), deploy, and restarted peers 0 & 1 (but not 2), and more Invokes " )
