...
func main() {
	...
	chco2.CurrentTestName = "CAT_214_S1_IQ_S0_R1_IQ.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	// CAT_214_S1_IQ_S0_R1_IQ.go

	chco2.StopPeers( []int{ 1 } )
	chco2.InvokesUniqueOnEveryPeer()
	chco2.QueryAllPeers( "STEP 3, after STOP PEER 1, and Invokes" )
	peerNum := 0
	chco2.StopPeers( []int{ peerNum } )

	chco2.RestartPeers( []int{ R1 } )
	...
	chco2.QueryAllPeers( "STEP 7, after Restart PEER " + strconv.Itoa(peerNum) + " and Invokes" )
