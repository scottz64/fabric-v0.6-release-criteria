...
func main() {
	...
	chco2.CurrentTestName = "CAT_308_S0S1S2_IQ_R1_IQ_R0_IQ.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	// CAT_308_S0S1S2_IQ_R1_IQ_R0_IQ.go
	...
	chco2.QueryAllPeers( "STEP 6, after stopped 3 peers (including vp0), and restarted just peer 1, and more Invokes " )
	chco2.RestartPeers( []int{ 0 } )
	chco2.Invokes( chco2.InvokesRequiredForCatchUp )
	chco2.QueryAllPeers( "STEP 9, after stopped 3 peers (including vp0), and restarted peer 0 after peer 1 (all running but vp2), and more Invokes " )
	...
	chco2.QueryAllPeers( "STEP 12, after many more Invokes")
