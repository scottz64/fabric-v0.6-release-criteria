...
func main() {
	...
	chco2.CurrentTestName = "CAT_207_S2_IQ_S1_IQ_R1_IQ.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	chco2.Invokes( chco2.InvokesRequiredForCatchUp )
	chco2.QueryAllPeers( "STEP 6, after also STOP PEER " + strconv.Itoa(peerNum) + " and Invokes" )
	...
	chco2.QueryAllPeers( "STEP 9, after Invokes " )
