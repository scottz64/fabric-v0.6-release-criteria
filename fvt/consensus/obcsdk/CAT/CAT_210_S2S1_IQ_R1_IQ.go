...
func main() {
	...
	chco2.CurrentTestName = "CAT_210_S2S1_IQ_R1_IQ.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	// CAT_210_S2S1_IQ_R1_IQ.go

	peerNum := 1
	chco2.StopPeers( []int{ 2, 1 } )
	chco2.InvokesUniqueOnEveryPeer()
	chco2.QueryAllPeers( "STEP 3, after STOP PEERS 2, 1, and Invokes" )
	...
	chco2.QueryAllPeers( "STEP 6, after Restart PEER " + strconv.Itoa(peerNum) + ", and Invokes " )
