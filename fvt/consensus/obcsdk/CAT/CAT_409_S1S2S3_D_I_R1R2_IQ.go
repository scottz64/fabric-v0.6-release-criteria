...
func main() {
	...
	chco2.CurrentTestName = "CAT_409_S1S2S3_D_I_R1R2_IQ.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	//	DeployNewOnPeer(A int, B int, peer int)
	...
	// Example usages:
	// 
	// chco2.DeployNew( 9000, 1000 )		// deploy to default peer (highest/last peer)
	// chco2.DeployNewOnPeer( 9000, 1000, 0 )	// deploy on peer 0
...
fmt.Println("Sleep extra 60 secs") ; time.Sleep(chco2.SleepTimeSeconds(60))
	// chco2.DeployNew(10000, 10000) // won't work since peer 3 is down.
