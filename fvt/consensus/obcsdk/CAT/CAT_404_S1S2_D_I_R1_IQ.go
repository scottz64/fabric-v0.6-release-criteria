...
func main() {
	...
	chco2.CurrentTestName = "CAT_404_S1S2_D_I_R1_IQ.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	chco2.QueryAllPeers( "STEP 6, after stopped 2 peers, deploy, and restarted 1 peer and more Invokes " )
