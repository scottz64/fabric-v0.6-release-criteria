...
func main() {
	...
	chco2.CurrentTestName = "CAT_402_S1_DQIQDQIQ.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	chco2.QueryAllPeers( "STEP 2, after STOP PEER 1, and REDEPLOY with original A & B init values" )
	chco2.Invokes( chco2.InvokesRequiredForCatchUp )
