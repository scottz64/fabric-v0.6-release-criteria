...
func main() {
	...
	chco2.CurrentTestName = "CAT_301_S0S1S2_IQ_R0_IQ_R1_IQ.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	// CAT_301_S0S1S2_IQ_R0_IQ_R1_IQ.go
	...
	chco2.QueryAllPeers( "STEP 6, after stopped 3 peers (including vp0), and restarted just peer 0, and more Invokes " )
	chco2.RestartPeers( []int{ 1 } )
	chco2.Invokes( chco2.InvokesRequiredForCatchUp )
	chco2.QueryAllPeers( "STEP 9, after stopped 3 peers (including vp0), and restarted peer 1 (all running but vp2), and more Invokes " )
