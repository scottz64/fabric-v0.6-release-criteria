...
func main() {
	...
	chco2.CurrentTestName = "CAT_405_S0S1_D_I_R0_IQ.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	chco2.Invokes( chco2.InvokesRequiredForCatchUp )
	chco2.QueryAllPeers( "STEP 6, after stopped 2 peers (0 &1), deploy, and restarted 1 peer (0) and more Invokes " )
