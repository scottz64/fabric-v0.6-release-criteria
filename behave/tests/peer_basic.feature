...
#@doNotDecompose
#@wip
  Scenario Outline: chaincode example02 with 4 peers and 1 membersrvc, multiple peers stopped
...
Scenario: chaincode example02 with 4 peers and 1 membersrvc, many invokes
